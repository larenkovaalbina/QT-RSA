...
// Рандомит число меньшее срандомленных ранее для теста рабина-миллера
...
void RSA::encryption(BigInteger &  incoming_message, BigInteger & encrypted_messgae,BigInteger & exp,BigInteger & mod){
encrypted_messgae = fast_power(incoming_message, exp, mod);
